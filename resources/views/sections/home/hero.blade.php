<section
    id="beranda"
    class="relative min-h-screen pt-[88px]"
>
    {{-- Lingkaran background kiri
    <div
        class="pointer-events-none absolute -left-[240px] top-[120px]
                h-[820px] w-[820px] rounded-full bg-[#d7eefb]"
    ></div> --}}

    <div
        class="relative mx-auto grid min-h-[630px] max-w-[1320px]
                items-start gap-8 px-8 pb-8 pt-[85px]
                lg:grid-cols-[0.9fr_1.1fr]"
    >
        {{-- Konten kiri --}}
        <div class="relative z-10 max-w-[540px]">
            <span
                class="inline-flex rounded-full border-3 border-[#0b3472]
                       bg-[#d8f1ff] px-3 py-1
            ...
            <h1
                class="mt-3 text-5xl font-black uppercase leading-tight
                    tracking-tight text-[#123f86]
                    sm:text-[56px] lg:whitespace-nowrap lg:text-[62px]"
            >
                <span
            ...
            <p
                class="mt-5 max-w-[550px]
                       text-sm leading-[1.45] text-slate-800
                       sm:text-[18px]"
            >
            ...
            <a
                href="#deskripsi"
                class="mt-9 inline-flex items-center gap-7 rounded-full
                       bg-gradient-to-r from-[#0c408b] to-[#0765df]
                       px-11 py-4 text-[17px] font-bold text-white
